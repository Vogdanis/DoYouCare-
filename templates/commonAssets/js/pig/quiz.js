...
function evaluateAnswers(){
    ...
    ////Question 6
    if(answer6 === "1kg of lamb"){
        totalScore += unitScore;
        console.log(totalScore);
    }
    if(answer6 === "1kg of pork"){
        totalScore += 0;
        console.log(totalScore);
    }
    ...
    if(totalScore <= (unitScore * (numOfQuestions * 1 / 3))){
        console.log("You know jack shit about pork!");
        displayAnswer = "You know jack shit about pork!";
